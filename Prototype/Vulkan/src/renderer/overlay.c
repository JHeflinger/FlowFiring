...
static OverlaySSBO g_exposed_overlay_ssbo = (OverlaySSBO){ (TriangleID)-1, (VertexID)-1, (VertexID)-1, { 0, 0 }, { 0, 0 } };
...
static Edge g_single_selected_edge = (Edge){ (VertexID)-1, (VertexID)-1 };
