...
#define PREVIEW_PIPELINE_FLAGS   0b111111111100
#define BVH_PIPELINE_FLAGS       0b000111111100
#define SIMULATE_PIPELINE_FLAGS  0b000000000011
#define SIMULATE_SHADER_FLAG     0b1
#define PROPAGATE_SHADER_FLAG    0b10
#define CENTROID_SHADER_FLAG     0b100
#define HISTOGRAM_SHADER_FLAG    0b1000
#define HISTORY_SHADER_FLAG      0b10000
#define SCATTER_SHADER_FLAG      0b100000
#define LEAVES_SHADER_FLAG       0b1000000
#define BVH_SHADER_FLAG          0b10000000
#define REBIND_SHADER_FLAG       0b100000000
#define DEFAULT_SHADER_FLAG      0b1000000000
